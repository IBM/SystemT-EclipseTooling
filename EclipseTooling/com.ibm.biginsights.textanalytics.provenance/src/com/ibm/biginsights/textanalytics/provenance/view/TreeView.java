...
public class TreeView extends Display {
    ...
    public TreeView(Tree t, String label) {
        ...
        filter.add(new FontAction(treeNodes, FontLib.getFont(m_font, 14)));
    ...
    /*
     * Attempt to set a unicode font for the node render
     * based on the platform OS.
     */
    private static String setFont(){
    ...
    public static JComponent demo(String datafile, final String label) {
        ...
        search.setFont(FontLib.getFont(m_font, Font.PLAIN, 11));
        ...
        title.setFont(FontLib.getFont(m_font, Font.PLAIN, 14));
