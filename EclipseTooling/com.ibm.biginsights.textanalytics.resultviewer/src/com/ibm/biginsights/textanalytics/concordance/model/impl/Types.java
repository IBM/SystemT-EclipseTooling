...
public class Types implements ITypes {
  ...
  private final SortedMap<String, Boolean> typeMap = new TreeMap<String, Boolean>();
  
  public void put(String type, Boolean value) {
    this.typeMap.put(type, value);
  }

  public Set<String> getActiveTypes() {
    final SortedSet<String> set = new TreeSet<String>();
    for (Map.Entry<String, Boolean> entry : this.typeMap.entrySet()) {
  ...
  public void setActiveTypes(String[] activeTypes) {
    ...
    for (String type : getTypes()) {
      this.typeMap.put(type, FALSE);
    }
    for (String type : activeTypes) {
      this.typeMap.put(type, TRUE);
    }
  }

  public boolean isActiveType(String type) {
    return this.typeMap.get(type) == TRUE;
  }
