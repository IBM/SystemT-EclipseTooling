...
public class LocationFileBrowseAction extends Action {
	
	private IWorkbenchPage page;
	private ISelectionProvider selectionProvider;

	public LocationFileBrowseAction() {
		// zero-arg constructor for launch from task launcher
	}
	
	public LocationFileBrowseAction(IWorkbenchPage page, ISelectionProvider selectionProvider)
	{
		super();		
		setText(Messages.LOCATIONFILEBROWSEACTON_TITLE);
	...
	public void run() {		
		...
		if (selectionProvider==null) {
			...
			LocationSelectionDialog dlg = new LocationSelectionDialog(Activator.getActiveWorkbenchShell(), Messages.BROWSERHANDLER_BROWSE_DFS, null, null);
		...
		if (location!=null) 
			BrowserHandler.openFilebrowserURL(location, null);				
	}
