...
/**
 * TreeViewer for the By Type View
 * 
 * 
 * 
 */
public class CollDiffByTypeTree extends CollDiffAbstractResultTree {
	 ...
	 */
	public CollDiffByTypeTree(final FormToolkit toolkit, final Composite parent,
			final AnalysisResultExplorer explorer, FileDiffViewOpenListener openListener) {
	...
	protected CollDiffAbstractResultContentProvider createContentProvider(
		...
		return new CollDiffByTypeContentProvider(explorer);
	}
