...
public class ShowSolutionHandler extends AbstractHandler
{
    ...
    {
        String solutionId = p_event.getParameter( ShowSolutionCommandAction.SHOW_SOLUTION_ID_PARM );
         try
        {
            QuickLaunchSolutionManager.setSolutionId( solutionId );
            QuickLaunchSolutionManager.showSolutionTabChange();
