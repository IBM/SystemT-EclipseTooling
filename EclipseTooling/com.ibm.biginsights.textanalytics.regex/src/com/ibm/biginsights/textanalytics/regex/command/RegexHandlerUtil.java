...
/**
 * Utilities for the regex command handlers.
 */
public class RegexHandlerUtil {
   ...
   * @return
   */
  public static final ITypedRegion getRegexRegion(ExecutionEvent event, AQLEditor editor)
    ...
    try {
      ...
      throw new ExecutionException(Messages.RegexHandlerUtil_REGEX_CMD_ERROR, e);
    }
    return result;
  }
  
  public static final String wrapStringAsRegex(final String regex) {
