 ...
 *  Kalakuntla
 */
public class CsvDocAnnotator extends DocumentAnnotator
{
  ...
  /**
   * Constructor to instantiate the CSV Document annotator class, This in turn calls the constructor of
   * DocumentAnnotator.
   ...
   */
  public CsvDocAnnotator (IProject project, SystemTRunConfig runConfig, OperatorGraph operatorGraph,
    String filesToAnalyze, IFolder resultFolder, String tempDir, LangCode lang, ProvenanceRunParams provenanceRunParams) throws TextAnalyticsException
  {
    ...
    super.docReader = new DocReader (FileUtils.createValidatedFile (filesToAnalyze), operatorGraph.getDocumentSchema (), null, runConfig.getCsvDelimiterChar ());
  ...
  {
    String csvFName = new File (filesToAnalyze).getName ();
    String labelForCsvFiles = csvFName + "_" + tupleIndex;
    return labelForCsvFiles;
  }
