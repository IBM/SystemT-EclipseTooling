...
This document outlines the various responsibilities of contributor roles in SystemT Eclipse Tooling.
...
- [Open an
  issue](https://github.com/IBM/SystemT-EclipseTooling/issues/new)
  against the
  [SystemT](https://github.com/IBM/SystemT-EclipseTooling) repo
...
Maintainers are the technical authority for the SystemT Eclipse Tooling project.  They 
