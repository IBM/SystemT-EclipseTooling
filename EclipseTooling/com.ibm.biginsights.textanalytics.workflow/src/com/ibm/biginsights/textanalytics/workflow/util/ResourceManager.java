...
public class ResourceManager extends SWTResourceManager
{
  ...
  {
    try {
      return ImageDescriptor.createFromURL (FileUtils.createValidatedFile (path).toURI ().toURL ());
    }
  ...
  public static Image getPluginImage (Object plugin, String name)
  {
    ...
    try {
      ...
      if (url != null) { return getPluginImageFromUrl (url); }
    }
    catch (Throwable e) {
  ...
  {
    /* Unsecure code and Deprecated code
  ...
  private static URL getPluginImageURL (String symbolicName, String path)
  {
    ...
    if (m_designTimePluginResourceProvider != null) { return m_designTimePluginResourceProvider.getEntry (symbolicName,
      path); }
    // no such resource
    return null;
  }
   ...
   * this code is only called by the deprecated function getPluginImageDescriptor(Object, String).
  ...
  {
    /* Unsecure code removed - tagged by secure source scanning
