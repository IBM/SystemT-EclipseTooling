...
public class LoadRangeTest extends PDJobBasedTest
{

  public LoadRangeTest (String expected_path, String actual_path, ExperimentProperties properties)
  {
  ...
  public void runTest () throws Exception
  {
    ...
    job.loadRange ();
    Assert.assertTrue (job.getRange ()[0] == 1 && job.getRange ()[1] == 2);
    shutdown ();
  }
