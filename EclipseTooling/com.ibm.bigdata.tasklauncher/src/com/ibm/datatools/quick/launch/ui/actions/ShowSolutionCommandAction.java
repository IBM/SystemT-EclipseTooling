...
* @since 2010May05
*/
public class ShowSolutionCommandAction extends AbstractCommandHandlerAction 
{


    public static final String SHOW_SOLUTION_COMMAND = "com.ibm.bigdata.quick.launch.ui.commands.showSolutionHandler"; //$NON-NLS-1$
    public static final String SHOW_SOLUTION_ID_PARM = "solutionId"; //$NON-NLS-1$
    
    String m_solutionId;

    public ShowSolutionCommandAction()
    {
    	m_solutionId = QuickLaunchConstants.DATA_PERSPECTIVE;
    }
    public ShowSolutionCommandAction( String solutionId )
    {
            ...
            NotDefinedException, NotEnabledException, NotHandledException
    {
        ...
        {
            Command command = commandService.getCommand( SHOW_SOLUTION_COMMAND );
            
            IParameter urlParm = command
                    .getParameter( SHOW_SOLUTION_ID_PARM );
            Parameterization parm = new Parameterization( urlParm, this.m_solutionId );
