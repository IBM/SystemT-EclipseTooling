...
/**
 * This class is the handler class called when "prev page" is clicked on the
 * Annotation Explorer.
 * 
 *  Madiraju
 * 
 */
public class ShowPrevPageHandler extends AbstractPageHandler {
	...
	public Object execute(ExecutionEvent event) {
		...
		try {
				...
				String originTableView = event.getParameter(resultViewerPrevPageCommandParameter); //Value present when Show prev page command is called from Table view.
				if (originTableView == null) {
					originTableView = ""; //Show prev page command issued from Annotation Explorer does not provide any parameter; Setting it to "".
				}
