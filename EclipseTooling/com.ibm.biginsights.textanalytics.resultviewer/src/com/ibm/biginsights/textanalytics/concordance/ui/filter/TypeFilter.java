...
public class TypeFilter extends ViewerFilter {
  ...
  public TypeFilter(ITypes types) {
    super();
    this.types = types;
  }
  
  public void setTypes(ITypes newTypes) {
    this.types = newTypes;
  }
  ...
  public boolean select(Viewer viewer, Object parentElement, Object element) {
    if (element instanceof IConcordanceModelEntry) {
      final String type = ((IConcordanceModelEntry) element).getAnnotationType();
      return this.types.isActiveType(type);
    }
    return false;
  }
