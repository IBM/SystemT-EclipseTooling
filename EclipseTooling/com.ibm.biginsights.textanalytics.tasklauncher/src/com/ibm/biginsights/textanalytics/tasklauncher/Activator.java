...
*******************************************************************************/
package com.ibm.biginsights.textanalytics.tasklauncher;
...
public class Activator extends AbstractUIPlugin {
	...
	public static final String IBM_COPYRIGHT =
		...
		" 5724-Y95                                                        " + //$NON-NLS-1$ 
		" (C) Copyright IBM Corp.  2012, 2012    All Rights Reserved.     " + //$NON-NLS-1$ 
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.ibm.biginsights.textanalytics.tasklauncher"; //$NON-NLS-1$
