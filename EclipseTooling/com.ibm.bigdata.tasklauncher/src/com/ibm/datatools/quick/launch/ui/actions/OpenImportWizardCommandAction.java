...
* @since 2010May05
*/
public class OpenImportWizardCommandAction extends AbstractCommandHandlerAction
{


    public static final String OPEN_NEW_WIZARD = "org.eclipse.ui.file.import"; //$NON-NLS-1$
    public static final String NEW_WIZARD_ID = "importWizardId"; //$NON-NLS-1$


    private String wizardId;

    public OpenImportWizardCommandAction( String wizardId )
    {
