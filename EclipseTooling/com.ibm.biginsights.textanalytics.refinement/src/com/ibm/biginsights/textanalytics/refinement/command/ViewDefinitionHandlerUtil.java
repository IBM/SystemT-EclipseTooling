...
/**
 * Utilities for the refinement command handler.
 * 
 * TODO: this needs to be consolidated with similar handlers in regex and pattern discovery plugins.
 */
public class ViewDefinitionHandlerUtil {
      ...
      throws ExecutionException 
  {
    ...
    int offset = 0;
    // Check if we have a valid selection. We don't check that the whole selection is in a view name, we
    ...
    try {
      ...
      throw new ExecutionException("Error executing refinement command.", e);
    }
