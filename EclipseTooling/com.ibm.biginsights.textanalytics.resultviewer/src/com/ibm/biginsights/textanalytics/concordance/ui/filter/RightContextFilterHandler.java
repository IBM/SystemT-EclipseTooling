...
public class RightContextFilterHandler extends TextPatternFilterHandler {



  public RightContextFilterHandler() {
    super(RIGHT_CONTEXT, "Right Context Text Filter",
        "Specify a text pattern that the right context must match.\nUse '*' as a wildcard character, e.g., \"*foo*bar*\".");
  }
