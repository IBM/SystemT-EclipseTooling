...
/**
 * This class handles the click event on popup menu 'Labeled Document Collection -> Mark Incomplete'
 * invoked on a gsFolder or gsFile from the package or project explorer. 
 *
 *  Krishnamurthy
 *
 */
public class ExplorerMarkIncompleteActionHandler extends
		AbstractExplorerMarkCompleteIncompleteActionHandler {


	
	public ExplorerMarkIncompleteActionHandler() {
		super();
		super.ACTION_TYPE = ACTION_TYPE_MARK_INCOMPLETE;
	}
