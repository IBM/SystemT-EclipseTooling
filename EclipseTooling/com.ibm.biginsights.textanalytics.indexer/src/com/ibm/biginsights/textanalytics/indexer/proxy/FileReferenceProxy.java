...
/**
 * Proxy class the wraps FileReference object
 * 
 *  Krishnamurthy
 */
public class FileReferenceProxy extends ReferenceProxy
{
  ...
  public FileReferenceProxy (Integer fileRefID)
  {
    fileRef = fileCache.getFileReference (fileRefID);
  }
