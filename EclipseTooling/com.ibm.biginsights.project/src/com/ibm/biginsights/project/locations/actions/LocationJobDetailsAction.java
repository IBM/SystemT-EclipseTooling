...
public class LocationJobDetailsAction extends Action {
	
	private IWorkbenchPage page;
	private ISelectionProvider selectionProvider;

	public LocationJobDetailsAction() {
		// zero-arg constructor for launch from task launcher
	}
	
	public LocationJobDetailsAction(IWorkbenchPage page, ISelectionProvider selectionProvider)
	{
		super();		
		setText(Messages.LOCATIONJOBDETAILSACTION_TITLE);
	...
	public void run() {		
		...
		if (selectionProvider==null) {
			...
			LocationSelectionDialog dlg = new LocationSelectionDialog(Activator.getActiveWorkbenchShell(), Messages.BROWSERHANDLER_JOB_DETAILS_OPEN, 
					Messages.LOCATIONJOBDETAILSACTION_DESC, null);
		...
		if (location!=null) 
			BrowserHandler.openJobIdURL(location, null);				
	}
